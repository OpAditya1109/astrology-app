      ...
      <nav className="bg-white shadow-md fixed w-full top-0 left-0 z-50">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-md px-6 py-6 flex flex-col gap-4">
            ...
            <Link to="/horoscopes" onClick={() => setIsMenuOpen(false)}>
              Daily Horoscope
            </Link>
            <Link to="/match-making" onClick={() => setIsMenuOpen(false)}>
              Matchmaking
            </Link>
            <Link to="/shopping" onClick={() => setIsMenuOpen(false)}>
              Shop
            </Link>
            <Link to="/occult" onClick={() => setIsMenuOpen(false)}>
              Courses
            </Link>
            ...
            {!token ? (
              ...
              <>
                <Link to="/user/wallet" onClick={() => setIsMenuOpen(false)}>
                  Wallet
                </Link>
                <button
                  onClick={() => {
